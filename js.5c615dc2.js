...
var updatePlayButton = function updatePlayButton() {
  playButtons.forEach(function (icon) {
    return icon.classList.toggle('hidden');
  });
  shape.forEach(function (icon) {
    return icon.classList.toggle('hidden');
  });
...
video.addEventListener('click', togglePlay); // Add class hidden when we accept the cookies notice
